            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 p-10 md:p-20 max-w-7xl mx-auto">
                <div data-aos="zoom-out-up" className="flex flex-col items-center bg-slate-400 py-10 rounded-lg">
                    ...
                    <div className="text-center mt-4">
                        ...
                        <p className="text-xl text-black mt-3">Founder <span className='font-mono'>&</span> CEO</p>
                    </div>
                ...
                <div data-aos="zoom-out-up" className="flex flex-col items-center bg-slate-400 py-10 rounded-lg">
                    ...
                    <div className="text-center mt-4">
                        ...
                        <p className="text-xl text-black mt-3">Human Resource Manager</p>
                    </div>
                    <div className='text-3xl flex gap-2 mt-2'>
                        <AiFillInstagram></AiFillInstagram>
                        <BiLogoFacebookCircle></BiLogoFacebookCircle>
                ...
                <div data-aos="zoom-out-up" className="flex flex-col items-center bg-slate-400 py-10 rounded-lg">
                    ...
                    <div className="text-center mt-4">
                        ...
                        <p className="text-xl text-black mt-3">COO</p>
                    </div>
                    <div className='text-3xl flex gap-2 mt-2'>
                        <AiFillInstagram></AiFillInstagram>
                        <BiLogoFacebookCircle></BiLogoFacebookCircle>
