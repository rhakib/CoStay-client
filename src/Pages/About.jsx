        ...
        <>
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center gap-10 p-10">
                <div className="flex-1">
                    ...
                    <p className="mt-10">Hotel CoStay welcomes you to enjoy comfort and luxury, a place where you will find exceptional three star facilities and world className hospitality.</p>
